...
public class Home extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
        ...
        public Home() {
            ...
            menuBar.setBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(170,220,255), new Color(128, 128, 128)));
            menuBar.setBackground(Color.CYAN);
            menuBar.setBounds(0, 10, 792, 35);
...
//            menuBar.add(mnHelp);
            ...
            l1.setForeground(new Color(34, 40, 66));
            l1.setFont(new Font("Segoe UI Semilight", Font.BOLD, 30));
            l1.setBounds(180, 45, 701, 80);
            contentPane.add(l1);
            ...
            panel.setBorder(new TitledBorder(new LineBorder(new Color(170,220,255), 5), "Operation", TitledBorder.LEADING,
...
//            contentPane.add(b6);
            ...
            Image i11 = i10.getImage().getScaledInstance(95, 95,Image.SCALE_DEFAULT);
            ImageIcon i12 = new ImageIcon(i11);
            l5 = new JLabel(i12);
            l5.setBounds(70, 452, 159, 163);
            contentPane.add(l5);
...
//            l7 = new JLabel(i18);
//            l7.setBounds(580, 460, 157, 152);
//            contentPane.add(l7);

            JPanel panel2 = new JPanel();
            panel2.setBorder(new TitledBorder(new LineBorder(new Color(170,220,255), 5), "Action", TitledBorder.LEADING,
				TitledBorder.TOP, null, new Color(34, 40, 66)));
